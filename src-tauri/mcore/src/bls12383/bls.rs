 ...
 */
use crate::bls12383::big;
use crate::bls12383::big::BIG;
use crate::bls12383::fp::FP;
use crate::bls12383::ecp;
use crate::bls12383::ecp::ECP;
use crate::bls12383::dbig::DBIG;
use crate::bls12383::ecp2::ECP2;
//use crate::bls12383::fp4::FP4;
use crate::bls12383::pair;
...
pub fn bls_hash_to_point(m: &[u8]) -> ECP {
    let dst= "BLS_SIG_BLS12383G1_XMD:SHA-256_SVDW_RO_NUL_";
