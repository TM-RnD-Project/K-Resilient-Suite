...
use crate::tweedledee::big;
use crate::tweedledee::big::BIG;
use crate::tweedledee::dbig::DBIG;
use crate::tweedledee::rom;
...
pub const MODBITS:usize = 255; /* Number of bits in Modulus */
pub const PM1D2: usize = 34;  /* Modulus mod 8 */
pub const RIADZ: isize = 1;  /* Z for hash-to-point */
pub const RIADZG2A: isize = 0;  /* G2 Z for hash-to-point */
pub const RIADZG2B: isize = 0;  /* G2 Z for hash-to-point */
pub const MODTYPE:usize=NOT_SPECIAL;
pub const QNRI:usize=5; /* Fp2 QNR 2^i+sqrt(-1) */
pub const TOWER:usize=NEGATOWER; /* Tower type */

pub const FEXCESS:i32 = ((1 as i32)<<25)-1;
